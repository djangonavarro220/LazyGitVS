...
- [ ] Full Squash-down parity remains open beyond the bounded slice: active-rebase todo edits, selected merge handling, dirty-worktree auto-stash, fixup/autosquash, and broader rebase UI (reword/edit/move) are intentionally absent.
