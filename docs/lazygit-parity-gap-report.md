...
- [ ] Full Edit parity remains open beyond the bounded partial Edit slice: active-rebase todo editing, merge commits/ranges, dirty-tree auto-stash, generic interactive rebase `i`, move/reorder, reword-with-editor, release/version/push/tag flows, and richer rebase UI are intentionally absent.
