...
class LazyGitVSController {
  ...
  private render(viewPanel: ViewPanel) {
    ...
    try { view.webview.html = `<!doctype html><html><head><meta charset="UTF-8"><meta http-equiv="Content-Security-Policy" content="${csp}"><style>
      html,body{height:100%;margin:0;}:root{--lgvs-font-size:var(--vscode-font-size);--lgvs-meta-size:clamp(10px,calc(var(--lgvs-font-size) - 2px),var(--lgvs-font-size));--lgvs-row-gap:1px;}body{font-family:var(--vscode-font-family);font-size:var(--lgvs-font-size);line-height:1.3;color:var(--vscode-foreground);background:var(--vscode-sideBar-background);overflow:hidden;}
