...
export const DEFAULT_LAZYGIT_KEYMAP: LazyGitKeymap = {
  universal: {
    ...
    select: '<space>', goInto: '<enter>', remove: 'd', new: 'n', edit: 'e', openFile: 'o', pushFiles: 'P', pullFiles: 'p', refresh: 'R', startSearch: '/', copyToClipboard: '<c-o>',
    diffingMenu: 'W', diffingMenuAlt: '<ctrl+e>', createRebaseOptionsMenu: 'm', toggleWhitespaceInDiffView: '<ctrl+w>', increaseContextInDiffView: '}', decreaseContextInDiffView: '{', increaseRenameSimilarityThreshold: ')', decreaseRenameSimilarityThreshold: '(', undo: 'z', redo: 'Z'
  },
  files: { copyPath: '<c-o>', copyFileInfoToClipboard: 'y', openStatusFilter: '<c-b>', toggleTreeView: '`', collapseAll: '-', expandAll: '=', sortOrder: 's', commitChanges: 'c', commitChangesWithoutHook: 'w', amendLastCommit: 'A', commitChangesWithEditor: 'C', refreshFiles: 'r', stashAllChanges: 's', viewStashOptions: 'S', toggleStagedAll: 'a', viewResetOptions: 'D', viewUpstreamResetOptions: 'g', confirmDiscard: 'x', ignoreFile: 'i', fetch: 'f' },
