...
export const DEFAULT_LAZYGIT_KEYMAP: LazyGitKeymap = {
  universal: {
    ...
    diffingMenu: 'W', diffingMenuAlt: '<ctrl+e>', toggleWhitespaceInDiffView: '<ctrl+w>', increaseContextInDiffView: '}', decreaseContextInDiffView: '{', increaseRenameSimilarityThreshold: ')', decreaseRenameSimilarityThreshold: '('
  },
