...
assert(extension.includes('if (!this.windowFocused) return;\n    if (this.intervalTimer) return;'), 'Periodic refresh interval must not start while VS Code is unfocused');
