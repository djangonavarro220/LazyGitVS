...
assert(dogfood.includes("(document.body.innerText || '').split('\\n')") && dogfood.includes('/^LazyGitVS(?:\\b|:)/'), 'editor tab inspection must count physical titles visible in the workbench instead of unstable internal tab DOM classes');
