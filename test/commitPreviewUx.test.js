...
assert(dogfood.includes('document.body.innerText') && dogfood.includes("function editorTabLabels(Runtime)") && dogfood.includes('LazyGitVS(?:'), 'editor tab inspection must count physical titles visible in the workbench instead of unstable internal tab DOM classes');
