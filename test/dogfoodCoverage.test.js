...
test('dogfood asserts the documented visible UI smoke path', () => {
  ...
  assert(dogfood.includes("'windowfocus', '--sync', 'key'"), 'native modal keys must target the visible Extension Development Host window instead of relying on ambient X focus');
