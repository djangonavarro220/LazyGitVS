...
test('dogfood covers high-risk gaps beyond the existing happy path', () => {
  ...
  for (const token of [
    ...
    'Large repo refresh preserves the active Files row when CDP can read it, otherwise keeps Files mode stable',
    'Large repo refresh storm is coalesced and remains responsive',
    'selectedLgvsRowInfo',
    'refreshStormElapsedMs',
