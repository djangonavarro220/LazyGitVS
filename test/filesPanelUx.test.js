...
assert(extension.includes("label += `/${visible.part}`"), 'Compressed file tree rows should display the real remaining path segment, e.g. karabiner/assets/complex_modifications');
