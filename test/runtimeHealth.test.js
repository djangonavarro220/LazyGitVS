...
assert(dogfood.includes("runExactCommand(Runtime, Input, 'LazyGitVS: Enter current file HUNK mode')"), 'Broad dogfood must retry HUNK entry through the exact command when synthetic key dispatch is lost');
